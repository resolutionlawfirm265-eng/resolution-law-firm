    ...
    >
      {socials.map((s) => (
        <a
          ...
          style={{ width: '44px', backgroundColor: s.color }}
          onMouseEnter={(e) => { 
            (e.currentTarget as HTMLElement).style.width = '155px';
            (e.currentTarget as HTMLElement).style.backgroundColor = s.hoverColor;
          }}
          onMouseLeave={(e) => { 
