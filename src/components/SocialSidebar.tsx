...
const socials = [
  {
    ...
    bg: '#1877F2',
    icon: (
      <svg viewBox="0 0 320 512" className="w-4 h-4 sm:w-5 sm:h-5 fill-white">
  ...
  },
  {
    ...
    bg: '#25D366',
    icon: (
      <svg viewBox="0 0 448 512" className="w-4 h-4 sm:w-5 sm:h-5 fill-white">
  ...
  },
  {
    ...
    bg: '#c4973b',
    icon: (
      <svg viewBox="0 0 512 512" className="w-4 h-4 sm:w-5 sm:h-5 fill-white">
