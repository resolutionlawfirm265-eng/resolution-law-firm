    ...
    <div>
      ...
      <section className="py-16 navy-gradient">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 text-center">
          ...
          <a href="tel:03237239957" className="inline-flex items-center gap-2 gold-gradient text-white px-8 py-4 rounded-lg font-bold hover:shadow-xl hover:shadow-gold/20 transition-all">
            <Phone size={20} /> Call 0323-7239957
          </a>
        </div>
      </section>
    </div>
